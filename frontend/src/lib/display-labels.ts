...
const fieldNames: Record<string, [string, string]> = {
  ...
  description: ["Deskripsi", "Description"], description_en: ["Deskripsi (English)", "Description (English)"], status: ["Status", "Status"], is_active: ["Status aktif", "Active status"], receives_internal_email_notifications: ["Notifikasi email internal", "Internal email notifications"], role: ["Role", "Role"], permissions: ["Hak akses", "Permissions"], password_changed: ["Password diubah", "Password changed"],
