...
export function Pagination({ meta, query, resourceName }: { meta: PaginationMeta; query: Record<string, string | undefined>; resourceName: string }) {
