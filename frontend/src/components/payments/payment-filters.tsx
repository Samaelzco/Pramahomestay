...
type Props = { search?: string; status?: string; method?: string; dateFrom?: string; dateTo?: string; perPage?: string };

export function PaymentFilters({ search, status, method, dateFrom, dateTo, perPage }: Props) {
