    ...
    <form action={formAction} className="mt-10 max-w-4xl">
      ...
      <section className="grid gap-6 border-t py-8 lg:grid-cols-[220px_1fr]">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <label className="text-xs font-semibold tracking-[0.08em] text-muted uppercase">Fasilitas<input name="amenities" defaultValue={room?.amenities.join(", ") ?? "Wi-Fi, AC"} placeholder="Pisahkan dengan koma" className={inputClass} /><FieldError errors={state.errors?.amenities} /></label>
