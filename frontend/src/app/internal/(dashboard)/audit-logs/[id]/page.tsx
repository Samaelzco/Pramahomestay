...
const fieldLabels: Record<string, string> = {
  ...
  address: "Alamat", maps_url: "Tautan Google Maps", logo_path: "File logo", logo_url: "URL logo",
  check_in_time: "Jam check-in", check_out_time: "Jam check-out", timezone: "Zona waktu", currency: "Mata uang",
  bank_name: "Nama bank", bank_account_number: "Nomor rekening", bank_account_holder: "Pemilik rekening",
  qris_notes: "Informasi QRIS", booking_code_prefix: "Prefix booking", payment_code_prefix: "Prefix pembayaran",
  cancellation_policy: "Kebijakan pembatalan", payment_instructions: "Instruksi pembayaran",
