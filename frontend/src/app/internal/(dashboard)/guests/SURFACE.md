...
- Lifecycle: profil dapat dinonaktifkan dan diaktifkan kembali tanpa menghapus riwayat; profil nonaktif tidak tersedia pada pemilih booking baru dan dapat ditemukan lewat filter status.
- Delete rule: profil tanpa riwayat booking dapat dihapus secara soft delete. Profil berelasi tidak menampilkan aksi hapus dan menjelaskan bahwa riwayat booking menguncinya.
