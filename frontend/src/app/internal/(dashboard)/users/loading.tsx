...
export default async function UsersLoading() {
  ...
  return (
    <main
      aria-busy="true"
      aria-label={serverLocalize(locale, "Memuat user", "Loading users")}
    ...
    >
      <div className="flex flex-col gap-6 sm:flex-row sm:justify-between">
        <div>
          <div className="h-12 w-64 rounded-sm bg-surface-high" />
      ...
      <div className="mt-8 h-5 w-36 rounded-sm bg-surface-high" />
