...
export default function RoomsLoading() {
  return (
    <main aria-busy="true" aria-label="Memuat daftar kamar" className="mx-auto min-h-[calc(100vh-64px)] max-w-[1440px] animate-pulse px-6 py-10 sm:px-8 md:px-10 md:py-12 xl:px-16">
      ...
      <div className="mt-8 grid gap-3 border-y py-5 md:grid-cols-[1fr_190px_190px_110px]"><Line className="h-12 w-full" /><Line className="h-12 w-full" /><Line className="h-12 w-full" /><Line className="h-12 w-full" /></div>
      ...
      <div className="mt-5 overflow-hidden rounded-lg bg-surface shadow-[0_18px_42px_-28px_rgba(68,71,72,0.25)]">
        ...
        <div className="divide-y">
          {Array.from({ length: 3 }, (_, row) => (
            <div key={row} className="grid gap-5 px-5 py-6 lg:grid-cols-[1.2fr_0.9fr_1.2fr_0.8fr_0.9fr_auto] lg:items-center lg:px-6">
