...
class UpdateRoomRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'images.*' => [File::image()->types(['jpg', 'jpeg', 'png', 'webp'])->max('5mb')],
            'remove_image_ids' => ['nullable', 'array', 'max:10'],
            'remove_image_ids.*' => ['integer', 'distinct', Rule::exists('room_images', 'id')],
            'remove_image' => ['sometimes', 'boolean'],
            'amenity_ids' => ['present', 'array', 'max:30'],
            'amenity_ids.*' => ['integer', 'distinct', Rule::exists('amenities', 'id')->whereNull('deleted_at')],
